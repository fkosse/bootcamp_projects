...
COPY categories FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/categories.csv' DELIMITER ',' CSV HEADER NULL 'NULL'; 
COPY territories FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/territories.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY suppliers FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/suppliers.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY shippers FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/shippers.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY regions FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/regions.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY customers FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/customers.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY employees FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/employees.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY employee_territories FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/employee_territories.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY products FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/products.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY order_details FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/order_details.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY orders FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/orders.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
COPY products FROM '/Users/FelixAir/Desktop/SPICED/bootcamp/class_material/week_05/data/products.csv' DELIMITER ',' CSV HEADER NULL 'NULL';
