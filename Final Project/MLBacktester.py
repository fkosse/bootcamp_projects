...
class MLBacktester():
    ...
    def test_strategy(self, train_ratio = 0.7, lags = 5):
        ...
        self.data_subset["position"] = predict
        
        # calculate Strategy Returns
        self.data_subset["strategy"] = self.data_subset["position"] * self.data_subset["returns"]
        
        # determine the number of trades in each bar
        self.data_subset["trades"] = self.data_subset["position"].diff().fillna(0).abs()
